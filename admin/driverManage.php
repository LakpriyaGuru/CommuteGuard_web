                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php $query = mysqli_query($con, "select * from driver");
                                                    $cnt = 1;
                                                    while ($result = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $result['driverEmail'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['driverAddress'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['driverNIC'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['driverContact'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['driverExp'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['driverRegDate'] ?>
                                                            </td>
                                                            <th>
                                                                <a href="driverEdit.php?said=<?php echo $result['driverID']; ?>"
                                                                    title="Edit Driver Details"> <i class="fa fa-edit"
                                                                        aria-hidden="true"></i> </a>
                                                                <a href="driverManage.php?action=delete&&said=<?php echo $result['driverID']; ?>"
                                                                    style="color:red;" title="Delete this record"
                                                                    onclick="return confirm('Do you really want to delete this record?');"><i
                                                                        class="fa fa-trash" aria-hidden="true"></i> </a>
                                                                <a href="driverResetPwd.php?said=<?php echo $result['driverID']; ?>"
                                                                    title="Reset Driver Password"> <i class="fa fa-key"
                                                                        aria-hidden="true"></i></a>
                                                            </th>
                                                        </tr>
                                                        <?php
