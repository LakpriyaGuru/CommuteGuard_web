                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php $query = mysqli_query($con, "SELECT s.*, c.childName FROM shift s, child c WHERE s.childID = c.childID;");
                                                    $cnt = 1;
                                                    while ($result = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $result['shiftMorning'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['shiftAfternoon'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $result['lastUpdate'] ?>
                                                            </td>
