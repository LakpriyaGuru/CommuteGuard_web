                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="parentName" name="parentName"
                            placeholder="Enter Parent Name" value="<?php echo $result['userName']; ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" id="validFrom" name="validFrom"
                            placeholder="Enter Valid From Date" value="<?php echo $result['validFrom']; ?>">
                        </div>

                        <div class="form-group">
                          <label for="text">Valid to</label>
                          <input type="date" class="form-control" id="validTo" name="validTo"
                            placeholder="Enter Valid To Date" value="<?php echo $result['validTo']; ?>">
                        </div>
