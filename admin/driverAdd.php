...
if (strlen($_SESSION['adminID']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO driver(driverName, driverEmail, driverPassword, driverAddress, driverNIC, driverContact, driverExp)
                                            VALUES ('$fullname', '$email', '$password', '$address', '$nic', '$mobilenumber', '$exp')");
    if ($query) {
      echo "<script>alert('Driver details added successfully.');</script>";
      echo "<script type='text/javascript'> document.location = 'driverAdd.php'; </script>";
    } else {
                    ...
                    <!-- Sub admin Email---->
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nic" name="nic" placeholder="Enter NIC Number"
                          pattern="[0-9]{9}|[0-9]{12}" title="9 digits without (X or V) OR 12 digits" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mobilenumber" name="mobilenumber"
                          placeholder="Enter email" pattern="[0-9]{10}" title="10 numeric characters only" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exp" name="exp" placeholder="Enter Experience Years"
                          pattern="[0-9]{1}" title="1 digits representing years" required>
                      </div>
