...
if (strlen($_SESSION['adminID']) == 0) {
  ...
  if (isset($_POST['reset'])) {
    ...
    $query = mysqli_query($con, "update driver set driverPassword='$password' where driverID='$driverID'");
    if ($query) {
      echo "<script>alert('Driver password reset successfully.');</script>";
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Reset Driver Password</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
